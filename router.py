...
BRANDS: dict[str, dict] = {
    'louis_vuitton': {
        ...
        'name_jp': 'ルイヴィトン',
        'keywords': ['ルイヴィトン', 'ルイ・ヴィトン', 'ルイビトン', 'ヴィトン'],
        'prefix':  'lv',
    ...
    'dior': {
        'name_fr': 'Dior',
        'name_jp': 'ディオール',
        'keywords': ['ディオール', 'クリスチャンディオール', 'DIOR'],
        'prefix':  'dior',
    ...
    'miumiu': {
        'name_fr': 'Miu Miu',
        'name_jp': 'ミュウミュウ',
        'keywords': ['ミュウミュウ', 'ミュウ・ミュウ', 'MIU MIU'],
        'prefix':  'miumiu',
    ...
    'balenciaga': {
        'name_fr': 'Balenciaga',
        'name_jp': 'バレンシアガ',
        'keywords': ['バレンシアガ', 'BALENCIAGA', 'バレンシアーガ'],
        'prefix':  'balenciaga',
    ...
    'vivienne_westwood': {
        ...
        'keywords': ['ヴィヴィアンウエストウッド', 'ヴィヴィアン・ウエストウッド', 'ビビアンウエストウッド', 'Vivienne Westwood'],
        'prefix':  'vw',
